<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $("#tabeljabatan").DataTable({
            ...
            "autoWidth": false,
            "language": {
                "sEmptyTable": "Data Jabatan Masih Kosong"
            },
    ...
    function edit(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('jabatan/edit') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                ...
                $('.modal-title').text('Ubah Jabatan'); // Set title to Bootstrap modal title
            ...
            success: function(data) {
                ...
                if (data.status) //if success close modal and reload ajax table
                {
                    ...
                    if (save_method == 'add') {
                        Toast.fire({
                            icon: 'success',
                            title: 'Jabatan Berhasil Disimpan!'
                        });
