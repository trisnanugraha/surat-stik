<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $("#tabelsindikat").DataTable({
            "responsive": true,
            "autoWidth": false,
            "language": {
                "sEmptyTable": "Data Sindikat Masih Kosong"
            },
            ...
            "ajax": {
                "url": "<?php echo site_url('sindikat/ajax_list') ?>",
                "type": "POST"
            },
    ...
    function add() {
        ...
        $('.modal-title').text('Tambah Sindikat'); // Set Title to Bootstrap modal title
    }
    ...
    function save() {
        ...
        if (save_method == 'add') {
            url = "<?php echo site_url('sindikat/insert') ?>";
        } else {
            ...
            success: function(data) {
                ...
                if (data.status) //if success close modal and reload ajax table
                {
                    ...
                    if (save_method == 'add') {
                        Toast.fire({
                            icon: 'success',
                            title: 'Sindikat Berhasil Disimpan!'
                        });
