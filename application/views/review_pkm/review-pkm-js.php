<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $("#tabelreview").DataTable({
            ...
            "autoWidth": false,
            "language": {
                "sEmptyTable": "Data Review PKM Masih Kosong"
            },
            ...
            "ajax": {
                "url": "<?php echo site_url('reviewpkm/ajax_list') ?>",
                "type": "POST"
            },
    ...
    function edit(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('reviewpkm/edit') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                ...
                if (data.berkas_review != '') {
                    var lokasiReview = "<?php echo base_url('upload/review/pkm/') ?>"
                ...
                $('.modal-title').text('Detail Review PKM'); // Set title to Bootstrap modal title
    ...
    function save() {
        ...
        if (save_method == 'add') {
            url = "<?php echo site_url('reviewpkm/insert') ?>";
        } else {
            url = "<?php echo site_url('reviewpkm/update') ?>";
        }
            ...
            success: function(data) {
                ...
                if (data.status) //if success close modal and reload ajax table
                {
                    ...
                    if (save_method == 'add') {
                        Toast.fire({
                            icon: 'success',
                            title: 'Data Review PKM Berhasil Disimpan!'
                        });
                    } else if (save_method == 'update') {
                        Toast.fire({
                            icon: 'success',
                            title: 'Data Review PKM Berhasil Diubah!'
                        });
                    }
                } else {
