...
class Mod_surat_keluar extends CI_Model
{

    var $table = 'tbl_surat_keluar';
    var $column_order = array('', 'id_surat_keluar');
    var $column_search = array('id_surat_keluar');
    var $order = array('id_surat_keluar' => 'desc'); // default order 
