...
class Mod_ajuan_pkm extends CI_Model
{

    var $table = 'tbl_ajuan_pkm';
    var $column_order = array('', 'judul_pkm', 'skema', 'status', 'status_reviewer');
    var $column_search = array('', 'judul_pkm', 'skema', 'status', 'status_reviewer');
